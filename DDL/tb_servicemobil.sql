...
--
ALTER TABLE `tb_perbaikan`
  ADD CONSTRAINT `tb_perbaikan_ibfk_1` FOREIGN KEY (`id_transaksi`) REFERENCES `tb_transaksi` (`id_transaksi`),
  ADD CONSTRAINT `tb_perbaikan_ibfk_2` FOREIGN KEY (`id_sparepart`) REFERENCES `tb_sparepart` (`id_sparepart`),
  ADD CONSTRAINT `tb_perbaikan_ibfk_3` FOREIGN KEY (`no_plat`) REFERENCES `tb_mobil` (`no_plat`),
  ADD CONSTRAINT `tb_perbaikan_ibfk_4` FOREIGN KEY (`id_montir`) REFERENCES `tb_montir` (`id_montir`);
